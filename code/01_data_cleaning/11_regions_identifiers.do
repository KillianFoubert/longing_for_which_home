********************************************************************************
* 11 - World Region Classification
* Bekaert, Constant, Foubert & Ruyssen (2024) - JEBO
********************************************************************************
*
* Purpose: Assigns countries to world regions for heterogeneity analysis.
*
* Input:   GWP region data
*
...
clear all
*cd "D:\Dropbox\Return Migration\Data\" // Fix PC Killian
cd "C:\Users\kifouber\Dropbox\Return Migration\Data\" // Laptop Killian
*cd "/Users/ilseruyssen/Dropbox/PhD Killian/Paper II/Data/"

use "Regions identifiers/Clean/dta/Base GWP origin region.dta", clear 
...
save "Regions identifiers/Clean/dta/Regions identifiers.dta", replace

rename region region_cntrycurrent
rename iso3o iso3_cntrycurrent

save "Regions identifiers/Clean/dta/Regions identifiers - Current country.dta", replace

rename region_cntrycurrent region_cntrybirth
rename iso3_cntrycurrent iso3_cntrybirth

save "Regions identifiers/Clean/dta/Regions identifiers - Birth country.dta", replace

rename region_cntrybirth region_dest
rename iso3_cntrybirth iso3_dest

save "Regions identifiers/Clean/dta/Regions identifiers - Dest.dta", replace
