********************************************************************************
* 10 - Political Instability (Polity IV)
* Bekaert, Constant, Foubert & Ruyssen (2024) - JEBO
********************************************************************************
*
* Purpose: Constructs democracy level and political instability dummies for host and home countries.
*
* Input:   Polity IV data
*
* Output:  Polity4 GWP (host/home).dta
*
...
clear all
*cd "D:\Dropbox\Return Migration\Data\" // Killian fix PC
*cd "/Users/ilseruyssen/Dropbox/Return Migration/Data/"
cd "C:\Users\kifouber\Dropbox\Return Migration\Data\" // Killian laptop
* add your path here

import excel "Polity IV\Old\Dta\p4v2017.xls", sheet("p4v2017") firstrow
...
save "Polity IV/Clean/Dta/Polity4 GWP", replace

rename iso3o iso3_cntrycurrent
rename pol* pol*_cntrycurrent
rename PolInstability PolInstability_cntrycurrent
rename PolInstab3y PolInstab3y_cntrycurrent

save "Polity IV/Clean/Dta/Polity4 GWP - Current country", replace

rename iso3_cntrycurrent iso3_cntrybirth
rename pol*_cntrycurrent pol*_cntrybirth
rename PolInstability_cntrycurrent PolInstability_cntrybirth
rename PolInstab3y_cntrycurrent PolInstab3y_cntrybirth

save "Polity IV/Clean/Dta/Polity4 GWP - Birth country", replace

rename iso3_cntrybirth iso3_dest
rename pol*_cntrybirth pol*_dest
rename PolInstability_cntrybirth PolInstability_dest
rename PolInstab3y_cntrybirth PolInstab3y_dest

save "Polity IV/Clean/Dta/Polity4 GWP - dest", replace
