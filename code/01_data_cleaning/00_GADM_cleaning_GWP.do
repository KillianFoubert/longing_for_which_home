********************************************************************************
* 00 - GADM Region Matching
* Bekaert, Constant, Foubert & Ruyssen (2024) - JEBO
********************************************************************************
*
* Purpose: Maps GWP region names to GADM level-1 administrative units.
*
* Input:   GWP2016 with GADM codes
*
* Output:  GWP with harmonised GADM identifiers
*
...
clear
shp2dta using "C:\Users\kifouber\Dropbox\Return Migration\Data\GADM\Old\dta\gadm36_0.shp", data(worlddata) coordinates(worldcoor) genid(id) replace
...
use "GWP/Old/dta/GWP2016withGADM.dta"
...
save "GWP\Clean\dta\GWP2016 ID_GADM_fine cleaned.dta", replace
